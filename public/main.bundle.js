...
module.exports = "<div class=\"header header-m\">\n    <div class=\"hdrInfo hdrInfo-m\">\n        <img src=\"../assets/images/noted_word3.png\" alt=\"Noted Logo\">\n        <br>\n        <button type=\"button\" (click)=\"isOpen = !isOpen\"><div class=\"menuIcon\"></div><div class=\"menuIcon\"></div><div class=\"menuIcon\"></div></button>\n    </div>\n    <span class=\"hdrLinks hdrLinks-m\" [ngClass]=\"{'hidden':isOpen==false}\"> <a [routerLink]=\"['dashboard']\" (click)=\"isOpen=false\">Home</a> <a [routerLink]=\"['dashboard','bands']\" (click)=\"isOpen=false\">Bands</a> <a [routerLink]=\"['dashboard','concerts']\" (click)=\"isOpen=false\">Concerts</a> <a id=\"logout\" (click)=\"logout()\">Logout</a></span>\n</div>\n\n<div class=\"backgroundImg\">\n    <!-- <img src=\"../assets/images/background1.jpg\" alt=\"Background of crowd at a concert\"> -->\n    <div class=\"mainContent\">\n        <router-outlet></router-outlet>\n    </div>\n</div>\n"
...
var AppModule = (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [__WEBPACK_IMPORTED_MODULE_5__app_component__["a" /* AppComponent */], __WEBPACK_IMPORTED_MODULE_6__login_login_component__["a" /* LoginComponent */], __WEBPACK_IMPORTED_MODULE_7__dashboard_dashboard_component__["a" /* DashboardComponent */], __WEBPACK_IMPORTED_MODULE_10__dashboard_bands_bands_component__["a" /* BandsComponent */], __WEBPACK_IMPORTED_MODULE_12__dashboard_concerts_concerts_component__["a" /* ConcertsComponent */], __WEBPACK_IMPORTED_MODULE_13__dashboard_friends_friends_component__["a" /* FriendsComponent */]],
            imports: [__WEBPACK_IMPORTED_MODULE_0__angular_platform_browser__["a" /* BrowserModule */], __WEBPACK_IMPORTED_MODULE_4__app_routing_module__["a" /* AppRoutingModule */], __WEBPACK_IMPORTED_MODULE_3__angular_http__["b" /* HttpModule */], __WEBPACK_IMPORTED_MODULE_2__angular_forms__["a" /* FormsModule */]],
            providers: [__WEBPACK_IMPORTED_MODULE_8__concerts_service__["a" /* ConcertsService */], __WEBPACK_IMPORTED_MODULE_9__users_service__["a" /* UsersService */], __WEBPACK_IMPORTED_MODULE_11__bands_service__["a" /* BandsService */]],
